...
import "../style/newstext.css"
import rasm1 from "../image/newsimg1.png"
import rasm2 from "../image/aboutHeroimg.png"
import rasm3 from "../image/newsimgg2.png"

function Newstext() {
  return (
  <section className='nexstext'>
    <div className="container">
<h1>Название статьи</h1>
<div className="news_btn_div">
<button>про </button>
<button>теги</button>
<button>много </button>
</div>
...
<div className="news_bottom">
    <h3>Поделится:</h3>
    <img src={rasm3} alt="" />
    <div className="news_bottom_wrappe">
    <div className="news_bottom_left">
        <h4>Название статьи в 
        два рядка</h4>
        <p>Предыдущая статья</p>
    </div>
    <div className="news_bottom_right">
        <h4>Название статьи в два рядка</h4>
